...
#include "include/com_androiddev_nativelog_loglib_NativeLogLib.h"

/* Java class and callback */
#define CB_CLASS "com/androiddev/nativelog/loglib/NativeLogLib"
...
JNIEXPORT jint JNICALL Java_com_androiddev_nativelog_loglib_NativeLogLib_LibMain(
	...
	__android_log_print(ANDROID_LOG_INFO, TAG,
			"Java_com_androiddev_nativelog_loglib_NativeLogLib_LibMain()");
...
JNIEXPORT jstring JNICALL Java_com_androiddev_nativelog_loglib_NativeLogLib_getNativeString(
	...
	__android_log_print(ANDROID_LOG_INFO, TAG,
			"Java_com_androiddev_nativelog_loglib_NativeLogLib_getNativeString()");
